(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["NDExStore"] = factory();
	else
		root["NDExStore"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.credActions = exports.cartActions = exports.luceneActions = exports.store = exports.storeName = undefined;

	var _redux = __webpack_require__(1);

	var _lucene = __webpack_require__(15);

	var luceneActions = _interopRequireWildcard(_lucene);

	var _cart = __webpack_require__(17);

	var cartActions = _interopRequireWildcard(_cart);

	var _credentials = __webpack_require__(18);

	var credActions = _interopRequireWildcard(_credentials);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	var storeName = 'ndex';
	var store = { lucene: luceneActions.default, cart: cartActions.default, credentials: credActions.default };

	exports.storeName = storeName;
	exports.store = store;
	exports.luceneActions = luceneActions;
	exports.cartActions = cartActions;
	exports.credActions = credActions;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = cyComponentState;
	exports.searchBegin = searchBegin;
	...
	var defaultState = (0, _immutable.Map)({
	  searching: false,
	  networkSummaries: (0, _immutable.Set)(),
	  error: null
	});

	function cyComponentState() {
	...
	function searchSuccess(networkSummaries) {
	  return { type: SEARCH_SUCCESS, networkSummaries: networkSummaries };
	}
	...
	function searchFor(query) {
	  var resultSize = arguments.length <= 1 || arguments[1] === undefined ? 50 : arguments[1];

	  return function (dispatch) {
	    return fetch('http://public.ndexbio.org/rest/network/search/0/' + resultSize, {
	      method: 'post',
	      headers: {
	      ...
	      if (response.status >= 200 && response.status < 300) {
	        response.json().then(function (networkSummaries) {
	          return dispatch(searchSuccess(networkSummaries));
	        });
	      } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DELETE_NETWORK = "REMOVE_NETWORK";
	var CLEAR = "CLEAR";

	var defaultState = (0, _immutable.Set)();
	...
	function addNetwork(network) {
	  return { type: ADD_NETWORK, network: network };
	}

	/*Delete network summary from store*/
	function deleteNetwork(network) {
	  return { type: DELETE_NETWORK, network: network };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = credentialsState;
	exports.login = login;
	...
	function login(name, pass) {
	  return { type: LOGIN, name: name, pass: pass };
	}

	/* Login to Ndex */
	function logout(name, pass) {
	  return { type: LOGOUT, name: name, pass: pass };
	}
